...
describe('Normalize GeoJSON Tests', () => {
    ...
    expect(feat.properties.start).toBeDefined();
    feat.properties.start = '2025-07-14T03:00:57.112Z';
    expect(feat.properties.time).toBeDefined();
    feat.properties.time = '2025-07-14T03:00:57.112Z';
    expect(feat.properties.stale).toBeDefined();
